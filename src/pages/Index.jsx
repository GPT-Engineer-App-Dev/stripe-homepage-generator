import { Container, Text, VStack, Box, Heading, Button, Flex, Image, HStack, Link } from "@chakra-ui/react";
...
const Index = () => {
  return (
    <Container maxW="container.xl" p={4} bg="purple.500">
      <HStack as="nav" spacing={4} bg="purple.600" p={4} color="white">
        <Link as={RouterLink} to="/" fontWeight="bold">Home</Link>
        <Link as={RouterLink} to="/about" fontWeight="bold">About</Link>
        <Link as={RouterLink} to="/services" fontWeight="bold">Services</Link>
        <Link as={RouterLink} to="/contact" fontWeight="bold">Contact</Link>
      </HStack>
      <Box>
